...
from main import CCTracingApp

# implement the functions of class with GUI
class CovidContactTracingAppGUI:
    ...
    def __init__(self, root):
        ...
        self.phone_label = tk.Label(root, text="Phone Number: ", font=("Times New Roman", 11, "bold"), bg="#F08080")
        ...
        # provide instance
        self.contact_tracing = CCTracingApp()
...
if __name__ == "__main__":
    ...
    app = CovidContactTracingAppGUI(root)
